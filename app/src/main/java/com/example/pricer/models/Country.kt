    ...
    companion object {
        fun getCountriesForList(context: Context, countriesResponse: ArrayList<String>): ArrayList<Country> {
            ...
            for (cr in countriesResponse) {
                ...
                when (cr) {
                    "Afghanistan" ->
                        country.countryFlag = ContextCompat.getDrawable(context,
                    ...
                    "Congo, Democratic Republic of the Congo" ->
                        country.countryFlag = ContextCompat.getDrawable(context,
                            R.drawable.democratic_congo
                        )
                    "Congo, Republic of the Congo" ->
                        country.countryFlag = ContextCompat.getDrawable(context,
                            R.drawable.republic_congo
                        )
                    "Costa Rica" ->
                        country.countryFlag = ContextCompat.getDrawable(context,
